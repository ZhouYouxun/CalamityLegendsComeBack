...
namespace CalamityLegendsComeBack.Weapons.BlossomFlux.SpecialArrow
{
    ...
    internal class BFArrow_DBomb : ModProjectile
    {
        ...
        {
            storedRainDamage = System.Math.Max(Projectile.damage, 1);
        ...
        public override void AI()
        {
            ...
            if (rainCounter % 12 == 0)
                SpawnBombardAuraFX(attachedNpc.Center, 0.7f);
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            storedRainDamage = System.Math.Max(Projectile.damage, storedRainDamage);
            State = 1f;
        ...
        private void SpawnArrowRain(NPC target)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                int projectileIndex = Projectile.NewProjectile(
                    ...
                    velocity,
                    storedAmmoType,
                    System.Math.Max(1, (int)(storedRainDamage * 0.55f)),
                    storedAmmoKnockback,
                    Projectile.owner);
            ...
            SpawnBombardAuraFX(target.Center, 0.85f);
        }
