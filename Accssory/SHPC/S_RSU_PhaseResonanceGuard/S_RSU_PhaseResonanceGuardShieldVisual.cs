...
{
    public class S_RSU_PhaseResonanceGuardShieldVisual : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            S_RSU_PhaseResonanceGuardPlayer modPlayer = owner.GetModPlayer<S_RSU_PhaseResonanceGuardPlayer>();
