...
namespace CalamityLegendsComeBack.Accssory.SHPC.Skill.TacticalComputer
{
    public class TacticalComputerPlayer : ModPlayer
    {
        ...
        public bool TacticalComputerVisualsHidden;
        ...
        public override void ResetEffects()
        {
            ...
            TacticalComputerVisualsHidden = false;
        }
        ...
        public override void PostUpdate()
        {
            ...
            if (TacticalComputerVisualsHidden)
            {
                KillNewReticleVisual();
                return;
            }
            ...
            // 旧准星本体是 TacticalComputerReticle 弹幕，目前继续禁用。
            // 如果以后要恢复旧准星显示，只需要重新调用 EnsureReticleVisual()。
            // EnsureReticleVisual();
        }
        ...
        {
            int visualType = ModContent.ProjectileType<TacticalComputerNEWReticle>();
            if (Player.ownedProjectileCounts[visualType] > 0)
                return;

            Projectile.NewProjectile(
                Player.GetSource_Misc("TacticalComputerNEWReticle"),
                ReticleWorld,
                Vector2.Zero,
                visualType,
                0,
