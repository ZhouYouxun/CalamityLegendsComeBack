...
namespace CalamityLegendsComeBack.Weapons.LeonidProgenitor.Effects.D_New6
{
    public class AdamantiteEffect : LeonidMetalEffect
    {
        ...
        protected override float EnergySizeFactor => 1.03f;
        ...
        public override void OnHitNPC(LeonidCometSmall meteor, Player owner, NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            int field = Projectile.NewProjectile(meteor.Projectile.GetSource_FromThis(), target.Center, Microsoft.Xna.Framework.Vector2.Zero, ModContent.ProjectileType<Shared_LingeringField>(), meteor.Projectile.damage / 3, 0f, meteor.Projectile.owner, 0f);
