...
namespace CalamityLegendsComeBack.Weapons.LeonidProgenitor.Effects.A_Pre8
{
    public class CopperEffect : LeonidMetalEffect
    {
        ...
        protected override float EnergySizeFactor => 0.82f;
        ...
        public override void OnHitNPC(LeonidCometSmall meteor, Player owner, NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            int bolt = Projectile.NewProjectile(meteor.Projectile.GetSource_FromThis(), target.Center, Main.rand.NextVector2CircularEdge(1f, 1f) * 6f, ModContent.ProjectileType<Copper_ChainLightning>(), meteor.Projectile.damage / 2, meteor.Projectile.knockBack, meteor.Projectile.owner, target.whoAmI, 2f);
