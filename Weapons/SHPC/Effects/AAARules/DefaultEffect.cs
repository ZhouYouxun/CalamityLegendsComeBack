...
namespace CalamityLegendsComeBack.Weapons.SHPC.Effects.AAARules
{
    public class DefaultEffect : RulesOfEffect
    {
        ...
        public override void OnKill(Projectile projectile, Player owner, int timeLeft)
        {
            ...
            int explosionSize = (int)(new BalanceSHPC().GetDefaultLeftClickExplosionRadius() * 1.65f);
        ...
        // 光芒大小（默认=原始行为）
        public override float GlowScaleFactor => 1f;

        // 光芒亮度（默认=原始行为）
        public override float GlowIntensityFactor => 0.9f;
