    ...
    public class LeonidProgenitorBombshell : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            Color trailColor = StealthVariant
                ? Color.Lerp(LeonidVisualUtils.GetMeteorColor(PrimaryEffectID, SecondaryEffectID), LeonidVisualUtils.MoonViolet, 0.28f)
                : LeonidVisualUtils.GetCelestialColor(0.2f, Projectile.whoAmI * 0.1f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color drawColor = StealthVariant ? Color.Lerp(LeonidVisualUtils.MoonWhite, LeonidVisualUtils.MoonViolet, 0.16f) : Color.Lerp(LeonidVisualUtils.GetCelestialColor(0.2f), lightColor, 0.22f);
            ...
            for (int i = 0; i < Projectile.oldPos.Length; i++)
            {
                ...
                Color afterimageColor = (StealthVariant ? LeonidVisualUtils.MoonWhite : LeonidVisualUtils.StratusBlue) * completion * (StealthVariant ? 0.6f : 0.25f);
        ...
        {
            Color impactColor = StealthVariant ? Color.Lerp(LeonidVisualUtils.MoonWhite, LeonidVisualUtils.MoonViolet, 0.18f) : LeonidVisualUtils.GetCelestialColor(0.2f, Projectile.whoAmI * 0.1f);
            ...
            LeonidVisualUtils.SpawnCelestialPulse(Projectile.Center, Projectile.oldVelocity, impactColor, StealthVariant ? 1.25f : 0.92f, StealthVariant ? 22 : 16);
        }
