...
{
    internal sealed class CosmicDischargeUltimateCooldown : CooldownHandler
    {
        public static new string ID => "CosmicDischarge_Ultimate";

        private CosmicDischargePlayer DischargePlayer => instance.player.GetModPlayer<CosmicDischargePlayer>();
        private float AdjustedCompletion => MathHelper.Clamp(DischargePlayer.UltimateEnergy / (float)CosmicDischargePlayer.UltimateEnergyMax, 0f, 1f);
        private int DisplayValue => DischargePlayer.UltimateEnergy;

        public override bool CanTickDown => false;
        public override bool ShouldDisplay => instance.player.HeldItem.type == ModContent.ItemType<NewLegendCosmicDischarge>() || DischargePlayer.UltimateFieldActive;
    ...
    {
        public static new string ID => "CosmicDischarge_QuickDraw";

        private CosmicDischargePlayer DischargePlayer => instance.player.GetModPlayer<CosmicDischargePlayer>();
        private float AdjustedCompletion => MathHelper.Clamp(DischargePlayer.QuickDrawCooldownTimer / 1800f, 0f, 1f);
        private int DisplayValue => DischargePlayer.QuickDrawCooldownTimer <= 0 ? 0 : (int)Math.Ceiling(DischargePlayer.QuickDrawCooldownTimer / 60f);
