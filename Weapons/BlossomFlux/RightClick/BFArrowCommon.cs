...
namespace CalamityLegendsComeBack.Weapons.BlossomFlux.RightClick
{
    internal static class BFArrowCommon
    {
        ...
        {
            BlossomFluxChloroplastPresetType.Chlo_ABreak => "CalamityLegendsComeBack/Weapons/BlossomFlux/RightClick/ABreak/BFArrow_ABreak",
            BlossomFluxChloroplastPresetType.Chlo_BRecov => "CalamityLegendsComeBack/Weapons/BlossomFlux/RightClick/BRecov/BFArrow_BRecov",
            BlossomFluxChloroplastPresetType.Chlo_CDetec => "CalamityLegendsComeBack/Weapons/BlossomFlux/RightClick/CDetec/BFArrow_CDetec",
            BlossomFluxChloroplastPresetType.Chlo_DBomb => "CalamityLegendsComeBack/Weapons/BlossomFlux/RightClick/DBomb/BFArrow_DBomb",
            BlossomFluxChloroplastPresetType.Chlo_EPlague => "CalamityLegendsComeBack/Weapons/BlossomFlux/RightClick/EPlague/BFArrow_EPlague",
            _ => "CalamityLegendsComeBack/Weapons/BlossomFlux/RightClick/ABreak/BFArrow_ABreak"
        };
